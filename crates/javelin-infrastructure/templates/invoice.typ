...
// --- Example Data Set ---
#show: invoice.with(
  receiver: "FooBar Systems, Inc.",
  invoice-no: "CI-2026-BEEF-01",
  date: "March 5, 2026",
  due-date: "April 30, 2026",

  // Logical Status Dimensions
  issue-type: "ORIGINAL", // Options: ORIGINAL, DUPLICATE, REVISED
  document-phase: "COMMERCIAL", // Options: COMMERCIAL, PROFORMA
  settlement: "UNPAID", // Options: UNPAID, PAID, OVERDUE

  registration-no: "T1234567890123",

  issuer: (
    name: "Deadlock Design Studio",
    department: "Chaos Engineering Div.",
    address: "404 Logic Gate, Null-Island, Tokyo 000-0000",
    tel: "+81-3-0000-0000",
  ),

  bank-info: (
    bank: "バイナリ中央銀行",
    branch: "ビット支店 (Branch Code: 010)",
    type: "普通 (Current)",
    number: "1010101",
    name: "デッドロック デザイン スタジオ",
  ),

  items: (
    (name: "Project 'Phoenix' UI/UX Design System (v2.0)", price: 404000, qty: 1, tax-rate: 10),
    (name: "Full-stack Refactoring & Technical Debt Cleanup", price: 128000, qty: 2, tax-rate: 10),
    (name: "Coffee & Pizza Supply for Late-night Debugging", price: 2048, qty: 16, tax-rate: 8),
    (name: "Unexpected Bug Fixes (Hotfix surcharge)", price: 50000, qty: 1, tax-rate: 10),
    (name: "Logical Consistency Consultation (MECE Optimization)", price: 31415, qty: 1, tax-rate: 10),
  ),
)
