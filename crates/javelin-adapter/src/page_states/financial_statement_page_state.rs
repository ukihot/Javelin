...
impl PageState for FinancialStatementPageState {
    fn route(&self) -> Route {
        // This is a legacy page state that should be accessed via FinancialStatementsMenu
        // but for backward compatibility, we keep the old route
        ...
        loop {
                    ...
                    event::read().map_err(crate::error::AdapterError::EventReadFailed)?
            {
                ...
                match key.code {
                    ...
                    KeyCode::Char('e') => {
                        return Ok(NavAction::Go(Route::FinancialStatementGenerationExecution));
                    }
