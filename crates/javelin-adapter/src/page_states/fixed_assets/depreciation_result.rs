...
use crate::{
    ...
    views::pages::DepreciationResultPage,
};

pub struct DepreciationResultPageState {
    page_id: Uuid,
    page: DepreciationResultPage,
...
impl DepreciationResultPageState {
    pub fn new(presenter_registry: Arc<PresenterRegistry>) -> Self {
        ...
        let page = DepreciationResultPage::new(page_id, depreciation_result_rx);
