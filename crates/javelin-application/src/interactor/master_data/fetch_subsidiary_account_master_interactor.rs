...
use crate::{
    ...
    input_ports::FetchSubsidiaryAccountMasterInputPort,
...
pub struct FetchSubsidiaryAccountMasterInteractor<Q, O>
where
...
impl<Q, O> FetchSubsidiaryAccountMasterInteractor<Q, O>
where
    Q: SubsidiaryAccountMasterQueryService,
    O: SubsidiaryAccountMasterOutputPort,
{
...
impl<Q, O> FetchSubsidiaryAccountMasterInputPort for FetchSubsidiaryAccountMasterInteractor<Q, O>
where
    Q: SubsidiaryAccountMasterQueryService,
    O: SubsidiaryAccountMasterOutputPort,
{
    async fn execute(
        ...
        let response = FetchSubsidiaryAccountMasterResponse { accounts: items };
